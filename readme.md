# Power equipment drone inspection data set for distribution defect 1900 images including horizontal bar corrosion and tower head

# Body

Power Equipment Drone Inspection Data for Discrete Faults in Power Distribution, 1900 Datasets, with Cable Crossarm Corrosion and Tower Top Damage as the Two Types, Marked. Supports YOLO format. Suitable for Object Detection, Algorithm Training, Research Use, Large Volume of Data, Directly Available.

order and ship immediately, .
